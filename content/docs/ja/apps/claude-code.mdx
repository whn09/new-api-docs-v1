...
<Callout type="info" title="Node.js環境のインストール手順">
  ...
  バージョンをクリックしてダウンロード（長期サポートバージョンを推奨）-
...
<Callout type="info" title="Claude Codeのインストール">
  PowerShellを開き、以下のコマンドを実行してください： ` npm install -g
  @anthropic-ai/claude-code ` このコマンドは、npm公式リポジトリからClaude
  Codeの最新バージョンをダウンロードしてインストールします。
</Callout>
...
<Callout
  type="info"
  title="~/.local/bin をPATHに追加（プロンプトで要求された場合のみ）"
>
...
<Callout type="info" title="Claude Codeのインストールを確認">
  ...
  ` claude --version `
  バージョン番号が表示されれば、おめでとうございます！Claude
  Codeは正常にインストールされました。
</Callout>
...
<Callout type="info" title="ワンクリック設定コマンド (Windowsシステム)">
  Claude
  Codeを中継サービスに接続するために、複数の環境変数を設定する必要があります：
</Callout>
...
<Callout type="info" title="Claude Codeの起動">
  ...
  特定のプロジェクトで使用する場合： ` # プロジェクトディレクトリに移動 cd
  C:\path\to\your\project ` ` # Claude Codeを起動 claude `
</Callout>
...
<Callout type="info" title="モデルの選択">
  コマンド： ` /model `
  を入力し、Enterキーを押してモデルを選択します。通常はデフォルト設定で問題ありません。
</Callout>
...
<Callout type="info" title="Claude Codeのインストール">
  ...
  オプション：プロンプトが表示されたら、提供されたコマンドを実行します ` echo
...
<Callout type="info" title="Claude Codeの起動">
  Claude Codeを直接起動します： ` # Claude Codeを起動 claude `
  特定のプロジェクトで使用する場合： ` # プロジェクトディレクトリに移動 cd
  /path/to/your/project ` ` # Claude Codeを起動 claude `
</Callout>
...
<Callout type="info" title="モデルの選択 (オプション)">
  コマンド： ` /model `
  を入力し、Enterキーを押して公式モデルを選択します。通常はデフォルトモデルで問題ありません。
</Callout>

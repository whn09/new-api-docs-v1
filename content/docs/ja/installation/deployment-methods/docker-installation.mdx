...
<Callout type="warn" title="強く推奨">
  Dockerコンテナを手動で起動するのではなく、[Docker Compose インストール方法](docker-compose-installation.md)を使用することを強く推奨します。Docker Compose方式は、より優れた設定管理、サービスオーケストレーション、およびデプロイ体験を提供します。
</Callout>

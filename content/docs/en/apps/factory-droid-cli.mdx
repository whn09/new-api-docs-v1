...
<Callout type="info" title="Launch Droid CLI">
  Launch Droid CLI directly: ` # Launch Droid CLI droid ` Use in a specific
  project: ` # Navigate to your project directory cd C:\path\to\your\project ` `
...
<Callout
  type="info"
  title='Installation prompts "permission denied" error'
  collapsible
>
...
<Callout type="info" title="PowerShell Execution Policy Error" collapsible>
  If you encounter an execution policy restriction, run: ` Set-ExecutionPolicy
...
<Callout type="info" title="Install Droid CLI">
  Open your terminal and run the following command: ` curl -fsSL

...
<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the New API console, you can add the following shortcut options for easy one-click population to FluentRead on the Token Management page:
</Callout>

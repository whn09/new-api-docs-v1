...
<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the New API console, the following shortcut options can be added to easily populate Cherry Studio with a single click on the token management page:
</Callout>

...
<Callout type="warn" title="Highly Recommended">
  We highly recommend using the [Docker Compose installation method](docker-compose-installation.md)
  instead of manually starting Docker containers. The Docker
  Compose method offers better configuration management, service orchestration, and deployment experience.
</Callout>

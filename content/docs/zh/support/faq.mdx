...
{/* TODO: Collapsible tip: 额度是什么？怎么计算的？ */}
...
{/* TODO: Collapsible tip: 账户额度足够为什么提示额度不足？ */}
...
{/* TODO: Collapsible tip: 渠道中的权重和优先级是什么？ */}
...
{/* TODO: Collapsible tip: 渠道测试报错：invalid character '<' looking for beginning of value */}

    此错误表示返回值不是合法的 JSON，而是一个 HTML 页面。

    最可能的原因是：您的部署站的 IP 或代理节点被 CloudFlare 封禁。

{/* TODO: Collapsible tip: 渠道测试报错：倍率或价格未配置，请联系管理员设置 */}
...
{/* TODO: Collapsible tip: ChatGPT Next Web 报错：Failed to fetch */}
...
{/* TODO: Collapsible tip: 报错：当前分组负载已饱和，请稍后再试 */}

    这表示上游渠道出现了 429 错误（请求过多）。

## 📦 数据库与升级问题

{/* TODO: Collapsible tip: 升级之后我的数据会丢失吗？ */}
...
{/* TODO: Collapsible tip: 升级之前数据库需要做变更吗？ */}

    一般情况下不需要，系统会在初始化时自动调整。

    如需特殊处理，会在更新日志中说明并提供相应脚本。

{/* TODO: Collapsible tip: 手动修改数据库后报错：数据库一致性已被破坏，请联系管理员？ */}
...
{/* TODO: Convert to Callout - note: 没有找到您的问题？ */}
如果这里没有解答您的问题，欢迎：
